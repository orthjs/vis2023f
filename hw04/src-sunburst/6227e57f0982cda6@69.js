...
md`參考自https://observablehq.com/d/c84affd948a1e733`
)}
...
d3
  .scaleOrdinal()
  .domain(["工作室", "替代空間", "美術館", "減少包裝材及文宣印製", "使用無毒媒材、再生材料、廢物利用素材等", "工作場所、活動展場的節約能源", "非營利組織/藝術團體", "校院", "藝術園區"])
  //.range(d3.schemePaired)
  .range(["#FC0A04","#FF9900","#FFFF00","#66FF33","#00CCFF","#FF00FF", "#51AF5A", "#B84868", "#9B8165"])
  .unknown("#BEBEBE")
)}
...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>不管是在哪種工作地點，大家採取最多的減碳行動幾乎都是減少包裝、再生材料與節約能源。</li>
    <li>相較於前幾名減碳行為，多設立符合永續精神的場地也可以幫助減少碳排放</li>
    <li>在各個場所哩，還是有許多人是被上級或因為壓力才配合減碳行動</li>
  </ul>
</h3>`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artist-1.csv", {url: new URL("../src/artist.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
