...
Inputs.form({
  ...
  fill_color: Inputs.select(["Gender", "LivingPlaceFirst", "Year"], {label: "fill color"}),
  tip: Inputs.radio([true, false], {label: "tips" , value: true}),
})
)}
...
Plot.plot({  
	...
	marginLeft: plot1.ml, 
	marks: [
		Plot.rectY(data, Plot.binX({y:"count"}, { x:"Year", interval:1, fill:plot1.fill_color, tip: plot1.tip })),    
		Plot.gridY({ interval: 1, stroke: "white", strokeOpacity: 0.5 })
	 ]
})
)}
