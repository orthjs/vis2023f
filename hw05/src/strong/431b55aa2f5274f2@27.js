...
function _3(simple){return(
simple.children = simple.children.filter(d => d.Group == 12)
)}
...
function _simple1(d3,simple,drag,url_list,invalidation)
{
  ...
  const colorScale = d3.scaleOrdinal(d3.schemeAccent); // 使用 D3 的顏色比例尺
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["simple"], _3);
